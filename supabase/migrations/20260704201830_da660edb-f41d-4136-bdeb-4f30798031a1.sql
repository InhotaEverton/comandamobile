...
BEGIN
  ...
  INSERT INTO public.configuracoes (
    ...
    responsavel_nome, responsavel_email, nome_fantasia, razao_social, email_comercial
  ) VALUES (
    v_empresa_id, 'ambos',
    false, 10, false,
    false, 0, false, v_default_horarios,
    false, 50, 'continua',
    v_nome_responsavel, NEW.email, v_nome_empresa, v_nome_empresa, NEW.email
  );
