  ...
  ({ className, ...props }, ref) => {
    return (
      <main
        ref={ref}
        className={cn(
          "relative flex w-full min-w-0 min-h-0 flex-1 flex-col overflow-hidden bg-background",
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn(
          "flex min-h-0 flex-1 flex-col gap-0 overflow-y-auto overflow-x-hidden sidebar-scroll group-data-[collapsible=icon]:overflow-hidden",
          className,
        )}
        {...props}
      />
